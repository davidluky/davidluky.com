...
function fallbackData(): GamingData {
  return {
    ...
    totalHours: 12340,
    hoursByPlatform: [
      { platform: "Steam", hours: 12281 },
      { platform: "Xbox", hours: 59 },
    ],
    ownedByPlatform: { steam: 1348, epic: 281 },
    recentGames: [
      { name: "Dota 2", platform: "steam", hours: 6357, lastPlayed: null },
      { name: "Shotgun King: The Final Checkmate", platform: "steam", hours: 16, lastPlayed: null },
      { name: "Street Fighter™ 6", platform: "steam", hours: 46, lastPlayed: null },
      { name: "3DMark", platform: "steam", hours: 19, lastPlayed: null },
    ],
    mostPlayed: [
      { name: "Dota 2", platform: "steam", hours: 6357, lastPlayed: null },
